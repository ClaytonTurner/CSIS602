class RockPaperScissors
  ...
  def self.winner(player1, player2)
    raise NoSuchStrategyError unless VALID.include?(player1[1]),"Strategy must be one of R,P,S"
    raise NoSuchStrategyError unless VALID.include?(player2[1]),"Strategy must be one of R,P,S"
